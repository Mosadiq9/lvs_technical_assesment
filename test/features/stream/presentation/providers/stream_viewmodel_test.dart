...
void main() {
  ...
  group('loadInitialData', () {
    test('emits loaded with categories and streams on success', () async {
      ...
      when(
        mockGetStreamsUseCase.call(categoryId: 'all'),
      ).thenAnswer((_) async => const Right([tStream]));
  ...
  group('selectCategory', () {
    test('emits loading then loaded with filtered streams', () async {
      ...
      when(
        mockGetStreamsUseCase.call(categoryId: 'gaming'),
  ...
  group('toggleFollow', () {
    test('updates stream in list on success', () async {
      ...
      when(
        mockFollowStreamerUseCase.call('s1'),
      ).thenAnswer((_) async => const Right(tStreamFollowed));
